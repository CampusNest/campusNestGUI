...
//                                     style={styles.image}
//                                 />
//                                 <Text>Description: {selectedApartment.description}</Text>
                    ...
                    apartmentData.map((apartment) => (
                        <View key={apartment.id} style={styles.apartmentContainer}>
                            ...
                            <View style={styles.textRow}>
                                ...
                                <Text style={styles.text}>Agreement and Commission: {apartment.agreementAndCommission}</Text>
                            </View>
                            <View style={styles.textRow}>
                                <Icon name="location-outline" size={20} color="#4F8EF7" />
                                <Text style={styles.text}>Location: {apartment.location}</Text>
                            </View>
                            <TouchableOpacity onPress={() => handleViewButtonPress(apartment)} style={styles.viewButton}>
