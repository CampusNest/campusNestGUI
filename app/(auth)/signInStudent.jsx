...
const SignInStudent = () => {
    ...
    const apiBaseUrl = 'http://172.16.0.183:9897/api/v1/studentLogin';
    ...
    const submit = async () => {
        try {
            ...
            if (response.data) {
                ...
                const profileResponse = await fetch(`http://172.16.0.183:9897/api/v1/studentProfile/${response.data.id}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    },
